...
async def start_bot():
    ...
    print(f"🔄 Подключаю admin_router: {admin_router}")  # <-- ДОБАВЬ ЭТО
    ...
    print("✅ Все роутеры подключены: start, queue, download, admin")
